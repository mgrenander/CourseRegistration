...
def attempt_register(semester, crn, session, sess_id):
    ...
    if semester == "201709":
        data = "assoc_term_in=dummy&crn=dummy&start_date_in=dummy&end_date_in=dummy&rsts=dummy&subj=dummy&crse=dummy&sec=dummy&levl=dummy&gmod=dummy&cred=dummy&title=dummy&mesg=dummy&regs_row=2&wait_row=0&add_row=10&rsts=&assoc_term_in=201709&crn=15469&start_date_in=09%2F05%2F2017&end_date_in=12%2F07%2F2017&subj=COMP&crse=558&sec=001&levl=Masters+%26+Grad+Dips+%26+Certs&gmod=Standard&cred=++++3.000&title=Fundamentals+of+Computer+Vision.&mesg=DUMMY&rsts=&assoc_term_in=201709&crn=2322&start_date_in=09%2F05%2F2017&end_date_in=12%2F07%2F2017&subj=COMP&crse=652&sec=001&levl=Masters+%26+Grad+Dips+%26+Certs&gmod=Standard&cred=++++4.000&title=Machine+Learning.&mesg=DUMMY&TERM_IN=201709&sel_crn=dummy&assoc_term_in=dummy&ADD_BTN=dummy&sel_crn=24586+201709&assoc_term_in=201709&ADD_BTN=Register"
    else:
...
print("NOTE: your McGill email/password and Minerva username/password must be the same in order for the script to work.")
